...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 x1:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      <h2 className='text-xl font-semibold mb-6 text-gray-800'> Community Image</h2>
      ...
      {images.length >0 ? (
           <div className='flex flex-wrap max-sm:justify-center gap-5'>
             {images.map((item , index)=>(
              ...
              <p className='absolute bottom-0 right-0 text-xs bg-black/50 backdrop-blur text-white px-4 py-1 roundedtl-xl opacity-0 group-hover:opacity-100 transition duration-300'>
